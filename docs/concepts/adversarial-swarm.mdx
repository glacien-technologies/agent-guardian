...
description: "The fourteen specialist agents, parallelism limits, Commander/Attacker/Evaluator split, and how the swarm decides which specialists to run against your target."
icon: "network"
---
...
Ten run by default — one per OWASP Agentic Security Initiative (ASI)
category. Four additional OWASP-LLM specialists run when you pass
`--include-m2-agents`.
