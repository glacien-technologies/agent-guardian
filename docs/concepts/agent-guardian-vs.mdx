...
This comparison is reviewed monthly. The next review is tracked in [`ROADMAP.md`](https://github.com/glacien-technologies/agent-guardian/blob/main/ROADMAP.md). If a competitor has shipped a feature that changes a row above, file a PR against `docs/concepts/agent-guardian-vs.mdx` or open an issue — corrections are merged on the next release.
