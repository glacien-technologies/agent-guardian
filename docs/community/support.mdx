...
<CardGroup cols={2}>
  ...
  <Card title="Join Discord" icon="message-square" href="https://discord.gg/h4FRgxvr">
  ...
  <Card title="Commercial support" icon="briefcase" href="/enterprise">
...
**AgentGuardian Enterprise**. See the [Enterprise](/enterprise)
...
- **No paid SLA support for OSS.** Community chat happens on [Discord](https://discord.gg/h4FRgxvr) on a best-effort basis.
