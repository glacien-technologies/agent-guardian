...
- **`EXIT_CONTRACT_INVALID` on startup.** Your `agentguardian.yaml`
  failed Pydantic validation. Run `agent-guardian contract validate
  agentguardian.yaml` to see the exact field error.

## Next step

- Author your contract with the wizard: `agent-guardian contract new`.
