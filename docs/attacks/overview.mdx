...
AgentGuardian ships **96 probes** across the 10 OWASP-ASI 2026 categories.
...
<CardGroup cols={1}>
  <Card title="Prompt injection (ASI01)" icon="message-square-warning" href="/attacks/prompt-injection">
    9 probes. Direct goal redirect, indirect-via-doc, role-swap pretext,
...
LangGraph demo and read the findings in [your first scan](/first-scan).
