...
A static reference rendering of a real scan output (JSON / SARIF surfaced as HTML) lives at [`docs/_assets/sample-report.html`](https://github.com/glacien-technologies/agent-guardian/blob/main/docs/_assets/sample-report.html). Open it locally to see the field set rendered before you run your first scan.
...
- Wire SARIF into GitHub code-scanning in [GitHub Actions](/ci/github-actions).
