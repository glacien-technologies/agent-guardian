...
<AccordionGroup>
  <Accordion title="`--output pdf` fails with PdfFeatureUnavailable" icon="triangle-alert">
  ...
  <Accordion title="`--model gemini:foo-bar` exits with `unknown model id`" icon="triangle-alert">
