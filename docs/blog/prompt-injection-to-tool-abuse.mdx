...
- replace a runtime gateway. If you need runtime governance see the AgentGuardian Enterprise tier at [/enterprise](/enterprise). The OSS layer documented in these docs is the developer-loop and the CI-gate, not the runtime.
