...
description: "Why single-prompt testers miss tool abuse, what changes when fourteen specialist attackers run concurrently, and how to point AgentGuardian at your own agent in five minutes."
icon: "rocket"
---
...
The roadmap is canonical in [`ROADMAP.md`](https://github.com/glacien-technologies/agent-guardian/blob/main/ROADMAP.md). The themes for the v1.1.x stream:
