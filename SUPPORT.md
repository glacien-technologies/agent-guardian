...
AgentGuardian is community-supported open source. There is no paid support tier in this repo.
...
Glacien Technologies (the maintainer) offers commercial support, hosted scanning, and a
managed dashboard tier. See [agentguardian.io/pricing](https://agentguardian.io/pricing).
The OSS project remains Apache-2.0 and feature-complete for self-hosted use.
