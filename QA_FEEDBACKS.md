...
- **Status** · **CLOSED** (2026-05-31, this commit) — dashboard punch list shipped; live screenshots match the new design; QA-024 (IDE delete + Executive Narrative restyle) + QA-025 (Mintlify docs rewrite) shipped immediately prior at `b8f9e8a / d7b1c56`; all three closures land in the same 2026-05-31 main sequence.
